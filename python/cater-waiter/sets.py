...
def check_drinks(drink_name, drink_ingredients):
    ...
    if any(True for ingredient in drink_ingredients if ingredient in ALCOHOLS):
...
def categorize_dish(dish_name: str, dish_ingredients: list) -> str:
    ...
    for value, name in ((VEGAN, "VEGAN"), (VEGETARIAN, "VEGETARIAN"), (PALEO, "PALEO"), (KETO, "KETO"), (OMNIVORE, "OMNIVORE")):
        if set(dish_ingredients) <= set(value):
