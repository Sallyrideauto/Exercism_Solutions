...
def approx_average_is_average(hand):
    ...
    # Strategy 1: Take the average of the first and last number in the hand
    first_last_average = (hand[0] + hand[-1]) / 2

    # Strategy 2: Using the median (middle card) of the hand
    middle_card_index = len(hand) // 2
    middle_card = hand[middle_card_index]

    # Check if either strategy results in a number equal to the actual average
